...
- `@tanstack/router`: ไลบรารีจัดการเส้นทางที่มีประสิทธิภาพสำหรับแอปพลิเคชัน React พร้อมคุณสมบัติเช่น เส้นทางซ้อนและการโหลดข้อมูล
- `@tanstack/router-devtools`: เครื่องมือสำหรับตรวจสอบและแก้ไขข้อบกพร่องในการจัดการเส้นทางของแอปพลิเคชันที่ใช้ `@tanstack/router`
...
## สร้างคีย์ลับ
เพื่อสร้างคีย์ลับ ให้รันคำสั่งต่อไปนี้ในเทอร์มินัลของคุณ:

```bash
node -e "console.log(require('crypto').randomBytes(256).toString('base64'));"
```

คำสั่งนี้จะแสดงสตริงสุ่มขนาด 256 ไบต์ที่เข้ารหัสแบบ base64 ซึ่งเหมาะสำหรับใช้เป็นคีย์ลับในแอปพลิเคชันของคุณ
